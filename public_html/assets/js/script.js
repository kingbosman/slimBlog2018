...
$(document).ready(function(){
    ...
    if(t_css3_index<t_css3_array.length&&!$.browser.msie)
    ...
    load_menu();
    load_contacts();
	console.log(t_browser_has_css3,t_css3_array[t_css3_index])
});
...
var load_main_slider = function(){
    $('.mainSlider').each(function(){
        var t_nav_time = 2000;   //time for navigation bar movement
        var t_items_time = 2000;   //time for item transition
        var t_interval_time = 5000;   //time for autoplay slide change
        var t_timeout_time = 5000;   //time to wait on clicked slide before autoplay resumes
        var t = $(this);
